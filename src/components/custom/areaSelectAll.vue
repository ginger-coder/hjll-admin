<template>
	<el-cascader class="dialog_forms_input_long"  :popper-class="isShowAll?'cascader2':'cascader1'"  :append-to-body="true" :clearable="isclearable" :disabled="isdisabled" v-model="value1" :options="regions" :props="props" @change="areaChange" :key="keyIndex" ref="cascader" placeholder="请选择区域" :collapse-tags="isCollapse"> </el-cascader>
</template>
<script>
