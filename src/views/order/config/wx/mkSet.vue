  ...
  <div style="height: 100%">
    ...
    <div class="form_box scrllbar">
      <div style="padding: 20px 20px 0 20px;">
        <div style="padding-bottom: 20px;font-size: 16px;font-weight: bold;">已选维修项目</div>
      ...
      <div class="table_box card_item">
        <div style="font-size:16px;font-weight:bold;margin:-20px 0 20px">添加维修项目</div>
...
import {getPollingItemDetail, updatePollingModule,getPollingItemPage,getPollingType} from "@/api/orderWxConfig";
