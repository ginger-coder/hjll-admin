      ...
      <!-- <el-scrollbar ref="dialogScrollbar" wrap-class="dialog-wrapper"> -->
        <el-form class="el-form-dialog" ref="form" :model="form" :rules="rules">
          ...
          <template v-if="moduleType=='Item'">
            <el-form-item class="" label="维修项目类型：" prop="pollingObject">
            ...
            <el-form-item class="" label="维修项目：" prop="pollingDevice">
...
import {getPollingType,savePollingModule,updatePollingModule} from "@/api/orderWxConfig";
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        pollingPeriod: [
          {required: true, type: 'number', message: `请选择维修周期`, trigger: 'change'}
        ],
        pollingDevice: [
          {required: true, type: 'number', message: "请选择维修项目", trigger: 'change'}
        ],
        pollingObject: [
          {required: true, type: 'number', message: `请选择维修项目类型`, trigger: 'change'}
        ],
      },
      form: {},
