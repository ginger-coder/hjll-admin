<template>
    <div>
        <el-dialog :title="(type!='create' ? '新建' : '新建') + title" :visible.sync="isShow" fullscreen :lock-scroll="true" :before-close="dialogCancel">
            <el-scrollbar ref="dialogScrollbar" wrap-class="dialog-wrapper">
                <el-form class="userForm" ref="form" :model="form" :rules="rules">
                    ...
                    <el-form-item  label="部门负责人：">
                        <el-select v-model="form.leader" placeholder="请选择" filterable clearable>
                            <el-option
                    ...
                    <el-form-item  label="管辖区域范围：">
                        <el-radio-group v-model="form.ranges" @change="getRanges">
            ...
            that.$refs["form"].validate((valid) => {
                if (valid) {
                    ...
                    let next = (post) => {
                        ...
                        let fun = that.type =='modify'? deptCreate :deptCreate
                        fun({}, param, post)
                            .then(() => {
                                that.$message({
                                    message: '提交成功',
