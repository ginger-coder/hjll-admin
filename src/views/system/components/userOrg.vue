<template>
    <div class="app-container-left">
        ...
        <el-scrollbar ref="deptTreeScroll">
            <el-tree ref="deptTree" :data="treeData" node-key="id" default-expand-all :filter-node-method="filterNode" :expand-on-click-node="false" @node-click="handleNodeClick">
                <div class="custom-tree-node" slot-scope="{ node, data }">
                    <span class="el-tree-node__label line_1_hidden">{{ data.name }}</span>
