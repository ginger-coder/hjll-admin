		...
		<div class="animate__animated" ref="animate">
			<div class="container-header" v-if="!StartFlag">
				...
				<div class="navList">
					...
					<div class="item2 nav-active">智能调度</div>
					<div class="item2">预检预修</div>
					<div class="item2" @click="onPage('/alarm')">监控告警</div>
				...
				<div class="container-left">
					<div class="count-share">
						...
						<div class="com-screen-content zyzl">
							...
							<div class="today_order_box" v-show="showZyzl">
								<div class="chart-box">
									<my-chart
										:style="{ height: '100%' }"
				...
				<div class="container-right">
					<div class="page-right-left">
						...
						>
							...
							<div class="com-screen-content error-order">
								<div class="bj">
									<div class="zbj"></div>
									<div class="fbj"></div>
									<div class="fbj2"></div>
...
import lineMap from '../components/lineMap/index.vue';
